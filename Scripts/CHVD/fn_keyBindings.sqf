...
systemChat format ["CH View Distance: использование клавиатуры активировано. Нажмите <%1%2> чтобы открыть меню настройки дальности видимости.", _SCAstring, [[_openSettingsKey select 0] call BIS_fnc_keyCode] call CBA_fnc_capitalize];