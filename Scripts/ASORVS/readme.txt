...
To open the vehicle selector, 'execvm' scripts\ASORVS\open.sqf. Parameters are as follows:
...
this addAction ["Spawn Helicopters" {[["helicopters"], [], "chopperspawn"] execvm "scripts\ASORVS\open.sqf";}];

//Spawn only B_MBT_01_mlrs_F and B_MBT_01_cannon_F on the "tankspawn" marker.
this addAction ["Spawn Tanks", {[["tanks"], ["B_MBT_01_mlrs_F", "B_MBT_01_cannon_F"], "tankspawn"] execvm "scripts\ASORVS\open.sqf";}];

Set up any settings you want (including blacklist) in scripts\ASORVS\config.sqf.
