...
class ASORVS_MinusButton :ASORVS_RscShortcutButton
{
	...
	//text= "scripts\ASORVS\images\minus_ca.paa";
	textureNoShortcut =  "scripts\ASORVS\images\minus_ca.paa";
	onButtonClick = "_this spawn ASORVS_fnc_PressMinus; false";
	sizeEx = TEXT_SIZE;
	/*animTextureDefault = "scripts\ASORVS\images\minus_ca.paa";
	animTextureNormal = "scripts\ASORVS\images\minus_ca.paa";
	animTextureDisabled = "scripts\ASORVS\images\minus_ca.paa";
	animTextureOver =  "scripts\ASORVS\images\minus_ca.paa";
	animTextureFocused = "scripts\ASORVS\images\minus_ca.paa";
	animTexturePressed =  "scripts\ASORVS\images\minus_ca.paa";*/
	w = ITEM_WIDTH;//1/30;
...
{
	textureNoShortcut =  "scripts\ASORVS\images\plus_ca.paa";
...
class ASORVS_Main_Dialog {
	...
	class controls {
		...
		class rotateDragThing : ASORVS_RscPicture
		{
			...
			type = 1;
			style = 48;
			//text="scripts\ASORVS\images\rotate_right.paa";
				font = "PuristaMedium";
