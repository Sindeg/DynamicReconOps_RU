...
_missileSpecialisedAA =["rhs_weap_igla","rhs_weap_fim92","launch_B_Titan_F", "launch_I_Titan_F","launch_O_Titan_F","launch_Titan_F", "launch_B_Titan_tna_F","launch_O_Titan_ghex_F","launch_I_Titan_eaf_F", "BWA3_Fliegerfaust"];
