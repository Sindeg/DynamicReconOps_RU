		...
		switch (_groundStyleSelect) do {
			case "FOB": {					
				...
				if (minesEnabled == 1) then {
					...
					[baseWorker, ["<t color='#09C1A8'>Арсенал вертолётов</t>",{[["helicopters"], _helicopters, "VVS_all_1"] execvm "scripts\ASORVS\open.sqf";},[], 1.5, false, true, "", "roleDescription player == '[Штаб] Командир взвода' || roleDescription player == '[Штаб] Офицер'", 5]] remoteExec ["addAction",0,true];
