...
_taskDesc = selectRandom [
	(format ["%1 имеет тайник с оружием где-то в области %2. Информация, предоставленная нам местными, сообщает нам что это оружие собирается вооружить независимую повстанческую группу, готовую совершать нападения на гражданское население. Уничтожьте этот тайник.", enemyFactionName, aoLocationName]),
